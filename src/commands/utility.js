    ...
    if (sub === 'help') {
      const embed = new EmbedBuilder()
        ...
        .addFields(
          ...
          { name: '📝 Applications', value: '`/application setup` `/application question add/remove/list` `/application toggle` `/application panel` `/application apply`' },
        ...
        .setFooter({ text: 'Dai Hood Remake Bot' });
      return interaction.reply({ embeds: [embed] });
    }
  }
};
